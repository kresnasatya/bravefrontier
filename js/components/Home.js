    ...
    <div class="flex flex-col justify-center items-center m-auto">
      <article class="p-4 mt-16">
        ...
        <div class="leading-loose">
          ...
          <p>The source code of this website is available by visit to <a href="https://github.com/kresnasatya/bravefrontier-netlify" target="_blank" rel="noopener" class="underline text-blue-700">github.com/kresnasatya/bravefrontier-netlify</a>.</p>
        </div>
        <h2 class="text-2xl my-4"><strong>Feedback</strong></h2>
        <div class="leading-loose">
          <p>If you have any feedback about feature(s) on this website please submit form in <a href="https://github.com/kresnasatya/bravefrontier-netlify/issues" target="_blank" rel="noopener" class="underline text-blue-700">github.com/kresnasatya/bravefrontier-netlify/issues</a></p>
        </div>
